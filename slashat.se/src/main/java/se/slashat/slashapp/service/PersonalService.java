...
public class PersonalService {
    ...
    public static Personal[] getPersonal(Type type) {
        ...
        if (type == Type.HOST) {
            ...
            personal[2] = new Personal("Magnus Jonasson", "Prylnörden", Type.ASSISTANT, R.drawable.magnus, "magnus@slashat.se", "magnusjonasson", "http://www.magnusjonasson.com",
        ...
        if (type == Type.DEV) {
            ...
            personal[0] = new Personal("Erika Thorsen", "iOS-drottning", Type.DEV, R.drawable.erika, "erika@akiri.se", "", "http://www.akiri.se/",
            ...
            personal[1] = new Personal("Hjälp till med appen!", "Sugen på att dra ditt strå till stacken?", Type.DEV, R.drawable.help_us, "slashat@slashat.se", "slashat", "http://slashat.se/",
