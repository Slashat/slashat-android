...
public class LiveFullscreenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.livefullscreenactitivty);
        setupActionBar();
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        videoProgressView = View.inflate(getApplicationContext(), R.layout.video_loading_progress, null);
        ...
        BambuserService.startStream("", new Callback<String>() {
            ...
            public void call(String result) {
                ...
                // Skip the media controller. In the end this will be the live stream without possiblity
                // to seek.
